...
###### Diagnostic plot for exponential distribution:  H(t) vs t #####
...
##### log-log plot (Diagnostic plot for Weibull distribution or Cox PH model) #####
...
##### Diagnostic plot for log-logistic distribution:  logit(S(t))  vs log(t) #####
...
##### Diagnostic plot for log-normal distribution: inverse cdf (1-S) vs log(T) #####
